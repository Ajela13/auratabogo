...
const Home = () => {
  return (
    <div className="flex flex-col items-center  backdrop-blur-sm  rounded-lg shadow-lg mt-25">
      <div className="relative flex flex-col items-center justify-center bg-gray-200 m-auto shadow-lg rounded-lg mt-10 w-full max-w-4xl h-48 sm:h-64 md:h-80 lg:h-[60vh]">
        <video src={video}  className="absolute top-0 left-0 w-full h-full object-cover rounded-lg " muted  autoPlay loop></video>
      </div>
      <div className=" text-white min-h-screen mt-15  flex items-center p-4 sm:p-8">
